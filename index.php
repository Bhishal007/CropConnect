...
<section id="latest-products" class="container mx-auto py-20">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <!-- Product Card 3 -->
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800 product-card">
      <img src="./Crop connect  images/Nuts & Oilseeds/PEANUTS.jpg" alt="Peanuts" class="w-full h-40 object-cover">
      <div class="p-4">
        <h3 class="text-xl font-semibold dark:text-white">Peanuts</h3>
        <p class="text-gray-600 dark:text-gray-400">₹12.00</p>
        <button class="mt-4 px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">Add to Cart</button>
      </div>
    </div>
    <!-- Product Card 4 -->
    ...
    <!-- Product Card 5 -->
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800 product-card">
      <img src="./Crop connect  images/Spices & herbs/Basil.jpg" alt="Basil" class="w-full h-40 object-cover">
      <div class="p-4">
        <h3 class="text-xl font-semibold dark:text-white">Basil</h3>
        <p class="text-gray-600 dark:text-gray-400">₹9.00</p>
        <button class="mt-4 px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">Add to Cart</button>
      </div>
    </div>
    <!-- Product Card 6 -->
    ...
    <!-- Product Card 8 -->
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800 product-card">
      <img src="./Crop connect  images/Spices & herbs/Black pepper.jpg" alt="Black pepper" class="w-full h-40 object-cover">
      <div class="p-4">
        <h3 class="text-xl font-semibold dark:text-white">Black pepper</h3>
        <p class="text-gray-600 dark:text-gray-400">₹22.00</p>
        <button class="mt-4 px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">Add to Cart</button>
      </div>
    </div>
  </div>
